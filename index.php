...
if (isset($_POST["like"]) && $_POST["like"] == "like") {
    ...
    header("location: index.php#id_bookmark_$newsfeed_id");
    // echo "<script>";
}
...
<body>
    ...
    <div class="newsfeed">
        ...
        while ($row = $query_newsfeed_list->fetch_assoc()) {
            ...
            // $friend_style_online = "style='border-radius: 50%; border: green 4px solid;'";
            echo "<a href='profile.php?friend_id=" . $nuser_id . "'><img src='./profile/" . $newsfeedProfile . "'  id='id_bookmark_$nid' width='60px' height='60px' " . $newsfeed_style_online . "></a>";
